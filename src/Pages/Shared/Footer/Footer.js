...
const Footer = () => {
    return (
        <footer className="footer p-10 bg-neutral text-neutral-content">
            <div>
                <h2 className="text-2xl">SalesBD</h2>
                <p>Sales BD Ltd.<br />Humna, cumilla, Bangladesh</p>
                <p>phone: <strong>01634146292</strong></p>
            </div>
            <div>
                ...
                <div className="grid grid-flow-col gap-4">
                    ...
                    <div>
                        <p>Copyright © 2022 - All right reserved by salesBD Ltd</p>
                    </div>
            </div>
        </footer>
    );
